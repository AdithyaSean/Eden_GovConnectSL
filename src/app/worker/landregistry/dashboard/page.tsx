...
const SERVICE_NAME = "Land Registry";
    ...
    <AdminLayout workerMode>
      <div className="flex-1 space-y-8 p-4 md:p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          <h1 className="text-3xl font-bold tracking-tight">Land Registry Dashboard</h1>
        </div>
        <Card>
          <CardHeader>
            <CardTitle>Land Registration Applications</CardTitle>
            <CardDescription>Review and manage all submitted applications for land registration.</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <TableBody>
                  {loading ? (
                    ...
                    <TableRow key={app.id}>
                      ...
                      <TableCell className="truncate max-w-sm">{app.details?.propertyAddress || 'N/A'}</TableCell>
                      ...
                      <TableCell className="text-right">
                        <Button asChild variant="outline" size="sm">
                          <Link href={`/worker/applications/${app.id}?from=/worker/landregistry/dashboard`}>
