...
const SERVICE_NAME = "National ID Services";
    ...
    <AdminLayout workerMode>
      <div className="flex-1 space-y-8 p-4 md:p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          <h1 className="text-3xl font-bold tracking-tight">Identity Services Dashboard</h1>
        </div>
        <Card>
          <CardHeader>
            <CardTitle>National ID Applications</CardTitle>
            <CardDescription>Review and manage all submitted applications for National ID cards.</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <TableBody>
                  {loading ? (
                    ...
                    <TableRow key={app.id}>
                      ...
                      <TableCell>{app.details?.serviceType || 'N/A'}</TableCell>
                      ...
                      <TableCell className="text-right">
                        <Button asChild variant="outline" size="sm">
                          <Link href={`/worker/applications/${app.id}?from=/worker/identity/dashboard`}>
