...
const SERVICE_NAME = "Passport Services";
    ...
    <AdminLayout workerMode>
      <div className="flex-1 space-y-8 p-4 md:p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          <h1 className="text-3xl font-bold tracking-tight">Immigration Dashboard</h1>
        </div>
        <Card>
          <CardHeader>
            <CardTitle>Passport Applications</CardTitle>
            <CardDescription>Review and manage all submitted applications for new passports or renewals.</CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <TableRow key={app.id}>
                      ...
                      <TableCell className="text-right">
                        <Button asChild variant="outline" size="sm">
                          <Link href={`/worker/applications/${app.id}?from=/worker/immigration/dashboard`}>
