...
const SERVICE_NAME = "Missing Documents";
const statuses = ['All', 'Pending', 'Approved', 'Rejected', 'In Progress', 'Completed'];

export default function WorkerMissingDocsDashboard() {
    ...
    <AdminLayout workerMode>
      <div className="flex-1 space-y-8 p-4 md:p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          <h1 className="text-3xl font-bold tracking-tight">Missing Documents Dashboard</h1>
        </div>
        <Card>
          <CardHeader>
            <CardTitle>Replacement Applications</CardTitle>
            <CardDescription>Review and manage all applications for lost or stolen documents.</CardDescription>
                ...
                <TableBody>
                  {loading ? (
                    ...
                    <TableRow key={app.id}>
                      ...
                      <TableCell className="capitalize">{app.details?.lostDocumentType?.replace('_', ' ') || 'N/A'}</TableCell>
                      ...
                      <TableCell className="text-right">
                        <Button asChild variant="outline" size="sm">
                          <Link href={`/worker/applications/${app.id}?from=/worker/missingdocuments/dashboard`}>
