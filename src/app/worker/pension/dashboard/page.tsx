...
const SERVICE_NAME = "Pension Department";
    ...
    <AdminLayout workerMode>
      <div className="flex-1 space-y-8 p-4 md:p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          <h1 className="text-3xl font-bold tracking-tight">Pensions Department Dashboard</h1>
        </div>
        <Card>
          <CardHeader>
            <CardTitle>Pension Applications</CardTitle>
            <CardDescription>Review and manage all submitted applications for pension registration.</CardDescription>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Last Workplace</TableHead>
                ...
                <TableBody>
                  {loading ? (
                    ...
                    <TableRow key={app.id}>
                      ...
                      <TableCell>{app.details?.lastWorkplace || 'N/A'}</TableCell>
                      ...
                      <TableCell className="text-right">
                        <Button asChild variant="outline" size="sm">
                          <Link href={`/worker/applications/${app.id}?from=/worker/pension/dashboard`}>
